...
export class BasemapService {
  ...
  // public projectionReferenceTypes= proj27700;


  public _baseMapType: string;
  private _currentMap: OlMap;
  @Output() iconChanger: EventEmitter<any> = new EventEmitter();
   
  // public projection2229 = proj2229;
  // public projection27700 = proj27700;
  // public projection23032 = proj23032;
  // public projection5479 = proj5479;
  // public projection3413 = proj3413;
  // public projection2163 = proj2163;
  // public projection2100 = proj2100;
  // public projection26911 = proj26911;
  // public projection2955Code = 'EPSG:2955';
  ...
  public getBaseMapProjection() {
   // return this.projection2955Code;
    console.log('final projection', this.finalProjection)
    return this.finalProjection;
    

  }
  public setBaseMapProjection(finalProjection) {
  //  this.projection2955Code = projection2955Code;
